        ...
        <el-col :span="12">
          <el-form-item label="文章类型：" prop="type">
            <el-select v-model="article.type" placeholder="请选择资料类型">
              <el-option label="Urine Therapy Real Case" value="01" />
              <el-option label="Urine Therapy Theory" value="02" />
              <el-option label="Urine Therapy Scientific Research" value="03" />
              <el-option label="Urine Therapy Book" value="04" />
              <el-option
                label="Personal Experience In Urine Therapy"
                value="05"
              />
              <el-option label="Urine Therapy Comprehensive Data" value="06" />
              <el-option label="Other Data" value="07" />
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    toAddUrineTherapyDataArticle(data) {
      addENUrineTherapyDataArticle(data).then((res) => {
        this.$message({
          message: "资料上传成功",
          type: "success",
        });
