...
<script>
import {
  getENUrineTherapyDataList,
  removeENUrineTherapyDataArticle,
  getUserInfo,
  createUser,
  getOpenid,
  getENUrineTherapyDataDetail,
...
export default {
  filters: {
    statusFilter(status) {
      const statusMap = {
        "01": "Urine Therapy Real Case",
        "02": "Urine Therapy Theory",
        "03": "Urine Therapy Scientific Research",
        "04": "Urine Therapy Book",
        "05": "Personal Experience In Urine Therapy",
        "06": "Urine Therapy Comprehensive Data",
        "07": "Other Data",
      };
  ...
  methods: {
    ...
    getDetail() {
      if (this.deleteForm.deleteId) {
        this.detailForm.id = this.deleteForm.deleteId;
        this.toGetENUrineTherapyDataDetail(this.detailForm);
      } else {
        this.$message({
          message: "请选择一条数据",
          type: "warning",
    ...
    //删除确认弹框的确定按钮
    confirm() {
      this.getremoveENUrineTherapyDataArticle(this.deleteForm);
    },
    ...
    toGetUrineTherapyDataList(data) {
      getENUrineTherapyDataList(data).then((res) => {
        // this.list = res;
        this.list = res.data;
    ...
    //详情接口
    toGetENUrineTherapyDataDetail(data) {
      getENUrineTherapyDataDetail(data)
        .then((res) => {
          this.$message({
            message: "获取详情成功",
            type: "success",
    ...
    //删除接口
    getremoveENUrineTherapyDataArticle(data) {
      removeENUrineTherapyDataArticle(data)
        .then((res) => {
          this.$message({
            message: "删除成功",
            type: "success",
