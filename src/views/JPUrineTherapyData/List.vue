...
<script>
import {
  getJPUrineTherapyDataList,
  removeJPUrineTherapyDataArticle,
  getUserInfo,
  createUser,
  getOpenid,
  ...
  methods: {
    ...
    getDetail() {
      if (this.deleteForm.deleteId) {
        ...
        this.toGetJPUrineTherapyDataDetail(this.detailForm);
      } else {
        this.$message({
          message: "请选择一条数据",
          type: "warning",
    ...
    //删除确认弹框的确定按钮
    confirm() {
      this.getremoveJPUrineTherapyDataArticle(this.deleteForm);
    },
    ...
    toGetUrineTherapyDataList(data) {
      getJPUrineTherapyDataList(data).then((res) => {
        // this.list = res;
        this.list = res.data;
    ...
    //详情接口
    toGetJPUrineTherapyDataDetail(data) {
      getJPUrineTherapyDataDetail(data)
        .then((res) => {
          this.$message({
            message: "获取详情成功",
            type: "success",
    ...
    //删除接口
    getremoveJPUrineTherapyDataArticle(data) {
      removeJPUrineTherapyDataArticle(data)
        .then((res) => {
          this.$message({
            message: "删除成功",
            type: "success",
